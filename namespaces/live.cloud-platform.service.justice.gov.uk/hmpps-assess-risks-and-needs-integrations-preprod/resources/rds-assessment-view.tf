...
locals {
  ...
  onr_secret_arn = "arn:aws:secretsmanager:eu-west-2:450842467489:secret:/postgres/database/hmpps-arns-assessment-view-db-preprod/cloud-platform-config-DpUKQR"
}
